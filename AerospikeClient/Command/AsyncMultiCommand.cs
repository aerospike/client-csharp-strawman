...
namespace Aerospike.Client
{
	/*public abstract class AsyncMultiCommand : AsyncCommand
	{
		...
		/// Batch constructor.
		/// </summary>
		public AsyncMultiCommand(Cluster cluster, Policy policy, Node node, bool isOperation)
			: base(cluster, policy)
		{
		...
		/// </summary>
		public AsyncMultiCommand(Cluster cluster, Policy policy, Node node, int socketTimeout, int totalTimeout)
